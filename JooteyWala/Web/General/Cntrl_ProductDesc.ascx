<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Cntrl_ProductDesc.ascx.cs" Inherits="JooteyWala.Web.General.Cntrl_ProductDesc" %>
		...
		<div class="cont span_2_of_3">
			...
			<div class="cont1 span_2_of_a1">
				...
				<div class="price_single">
							  <span class="reducedfrom"><i class="fa fa-inr"></i>66.00</span>
							  <span class="actual"><i class="fa fa-inr"></i>12.00</span><a href="#">click for offer</a>
							</div>
				<ul class="options">
