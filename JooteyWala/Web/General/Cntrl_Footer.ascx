<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Cntrl_Footer.ascx.cs" Inherits="JooteyWala.Web.General.Cntrl_Footer" %>
        ...
        <div class="content-top">
            ...
            <div class="cont span_2_of_c1">
                <div class="social">
                    ...
                    <li class="facebook">
                        <a href="#"><span> </span></a>
                        <div class="radius"> <img src="../images/radius.png"><a href="#"> </a></div>
    ...
    <div class="copy">
            <div class="wrap">
               <p>© All rights reserved | Template by&nbsp;<a href="http://google.com/"> ARM</a></p>
            </div>
         </div>